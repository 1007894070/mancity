						...
						<div class="col-lg-12">
							<div class="box dark">
								...
								<div id="div-1" class="body">
									<form class="form-horizontal" action="books/addBooks.action"
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" type="text"
													name="books.booksname" id="booksname" placeholder="请输入图书名称">
											</div>
										</div>
										<div class="form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" type="text"
													name="books.publisher" id="publisher" placeholder="请输入出版社">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select class="form-control" name="books.recommend" id="recommend">
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<select class="form-control" name="books.special" id="special">
													<option value="是">是</option>
													<option value="否">否</option>
												</select>
											</div>
										...
										<div class="form-group">
											...
											<div class="col-lg-8">
												<textarea class="form-control" name="books.comments"
													id="comments" style="height: 120px"></textarea>
											</div>
										</div>
